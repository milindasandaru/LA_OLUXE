...
const Add = ({token}) => {
  ...
  const [category, setCateory] = useState("Topwear");
  const [subCategory, setSubCateory] = useState("Topwear");
  ...
  return (
    <form onSubmit={onSubmitHandler} className='felx flex-col w-full items-start gap-3'>
      <div className="">
      ...
      <div className="">
        ...
        <select onChange={(e) => setCateory(e.target.value)} className='w-full px-3 py-2'>
      ...
      <div className="">
        <p className='mb-2'>Product category</p>
        <select onChange={(e) => setSubCateory(e.target.value)} className='w-full px-3 py-2'>
      ...
      <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, blanditiis officiis. Repellat velit aperiam quaerat atque omnis reprehenderit dolor dolorum totam. Ab ipsa laborum repellendus pariatur vitae adipisci ipsam laudantium.</p>
    </form>
  )
}
